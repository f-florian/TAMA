...
def generate_table():
    ...
    for client in tama.session.query(tama.Client):
        ...
        output += "   <td>"+str(client.last_on.strftime("%Y-%m-%d %H:%M:%S"))+"</td>"
        output += "   <td>"+str(client.last_off.strftime("%Y-%m-%d %H:%M:%S"))+"</td>"
        output += "   <td>"+str(client.last_busy.strftime("%Y-%m-%d %H:%M:%S"))+"</td>"
        output += "   <td>"+str(client.last_refresh.strftime("%Y-%m-%d %H:%M:%S"))+"</td>"
